...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backend = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BackendInterface = undefined;
	...
	var BackendInterface = exports.BackendInterface = function () {
	  function BackendInterface() {
	    _classCallCheck(this, BackendInterface);
	  ...
	  _createClass(BackendInterface, [{
	    key: "whoami",
	    value: function whoami() {
	      var _this = this;
	
	      return this.rq.get("/api/whoami").then(function (json) {
	        return new _models.User(_this, json.id, json.google_id, json.grant_type);
	      });
	    }
	  }, {
	    key: "listPhotos",
	    value: function listPhotos(user) {
	      var _this2 = this;
	
	      return this.rq.get("/api/user/" + user.id + "/photo/list").then(function (json) {
